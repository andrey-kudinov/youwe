...
function PrivacyPolicy() {
  return (
    <div className="container">
      <div className={`${styles.content} paragraph1`}>
        <h1>Privacy Policy for Avalon Innovations</h1>

        <div>
          <p>
            At avalon.au, accessible from https://avalon.au/, one of our main priorities is the privacy of our visitors.
            This Privacy Policy document contains types of information that is collected and recorded by avalon.au and
            how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            regards to the information that they shared and/or collect in avalon.au. This policy is not applicable to
          ...
          <h2>Log Files</h2>
          <p>
            avalon.au follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>
            Like any other website, avalon.au uses 'cookies'. These cookies are used to store information including
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of avalon.au.</p>
          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on avalon.au, which are sent directly to
          ...
          <p>
            Note that avalon.au has no access to or control over these cookies that are used by third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            avalon.au's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
          ...
          <p>
            avalon.au does not knowingly collect any Personal Identifiable Information from children under the age of
